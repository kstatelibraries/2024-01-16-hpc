...
venue: "K-State Libraries & Agricultural Research Service"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Jan 16-17, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Tom Misilo", "Kari Payne", "Teresa Shippy",  "Dave Turner"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["David Molik", "Kari Payne", "Erin Schirtzinger", "Teresa Shippy", "Dave Turner" ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
